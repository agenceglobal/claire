...
.parrafofirstletter p:first-letter {
   ...
   <section id="bannerhome">
    ...
    ?>
        ...
        <div class="medidas">
        <p class="coma">Descubre las <b style="color: var(--azul); font-style: italic;">habilidades</b> del <a href="seo-tecnico.html">SEO Técnico</a></p>
        </div>
        <img style="padding: 30px; z-index: -2;" src="/imagenes/imagen-seo-tecnico.png" alt="habilidades del SEO Técnico">
    </section>
    <section id="cuerpo">
        ...
        <div class="divpadre">
            ...
            <div>
                ...
                <div><p>esto es otro div con un párrafo y un <span>span</span></p></div>
            </div>
                <p>cuarto párrafo</p>
        </div>
    </section>
    <div class="herencias">
        <div class="parrafo"><p>parrafo 1 que pertence a párrafo</p>
        </div>
