...
?>
   <section>
        ...
        <table>
            ...
            <tr>
              <td>Dato de la columna 1</td>
              <td>Dato de la columna 2</td>
              <td>Dato de la columna 3</td>
            </tr>
            <tr>
              <td>2 Dato de la columna 1</td>
              <td>2 Dato de la columna 2</td>
              <td>2 Dato de la columna 3</td>
            </tr>
          </table>
        <div>Aquí vas a encontrar toda la información para convertirte en especialista en SEO Técnico</div>
        <p><a href="contactar.html">Infórmate sobre el curso de SEO Técnico</a></p>
        <div class="imagenfalsa"></div>
        <div class="opcionesimagen"></div>
        <div class="imagenbackground">
            <a href="https://www.agenceglobalweb.com/">Esto es enlace para la araña</a></div>
        <table>
            ...
            <tr>
                <td>Capital Europea</td>
                <td>Paris</td>
            </tr>
        </table>
        <picture>
        <img style="padding: 30px; display: none;" src="/imagenes/imagen-sobre-mi.png" alt="aspectos a trabajar del SEO Técnico" loading="lazy" width="800px" height="377px">
        </picture>
        <picture>
            <source type="image/avif" srcset="/imagenes/imagen-sobre-mi.avif">
            <div class="divfotoflex"><img src="/imagenes/imagen-sobre-mi.png" title="Imágen Aviv" alt="aspectos a trabajar del SEO Técnico" loading="lazy" width="800px" height="377px">
                <div>Esto es un texto al lado de una imagen</div></div>
        </picture>
    <section>
        <video width="320" height="240"controls autoplay muted>
            <source src="/videos/movie-oso.mp4" type="video/mp4">
            <source src="movie.ogg" type="video/ogg">
            Your browser does not support the video tag.
        </video>
    </section>
        <div style="background-color: rgb(255, 219, 87); padding: 5px; opacity: 0.5;" title="este div tiene un background amarillo">
            <h2 style="color: rgb(17, 46, 114);">Crawleo, Rendering e Indexación</h2>
